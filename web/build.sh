...
SOURCES=(
    src/main.cpp
    src/core/Game.cpp
    src/entities/Entity.cpp src/entities/Player.cpp
    src/entities/Enemy.cpp src/entities/Projectile.cpp
    src/systems/Starfield.cpp src/systems/EnemyFleet.cpp
    src/systems/PlayerWeapon.cpp src/systems/EnemyWeapon.cpp
    src/systems/CombatResolver.cpp src/systems/Hud.cpp
    src/scenes/MenuScene.cpp src/scenes/CreditsScene.cpp
    src/scenes/PlayScene.cpp src/scenes/GameOverScene.cpp
    src/platform/Platform.cpp src/platform/ResourceLibrary.cpp
    src/platform/AudioDirector.cpp src/platform/HighScoreStore.cpp
)
